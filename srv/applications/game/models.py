...
from srv.settings import MEDIA_URL, MEDIA_ROOT
from sets import Set

from srv.applications.symbolic_math.views import *
...
class ZeroPlayerGame(TimestamperMixin, models.Model):
    ...
    extraIncludes = models.ManyToManyField('JSLibrary', blank=True)
    mainImage = models.CharField(null=True, blank=True, max_length=255)
    required_modules = models.ManyToManyField('CodeModule', blank=True)
    popularity = models.IntegerField(default=1)
